...
export default function Home() {
  ...
  return (
    <main className=' min-h-screen overflow-hidden'>
        ...
        <div className='container mx-auto pt-0 md:pt-10 relative'>
          ...
          >
            ...
            <div className='flex flex-col w-full gap-5 items-center justify-center mt-5'>
              <Select>
                <SelectTrigger className='max-w-xl outline-0 text-[#FFF] text-[10px] border-b-1 border-x-0 border-t-0 rounded-none px-0'>
              ...
              <Select>
                <SelectTrigger className='max-w-xl text-[#FFF] text-[10px] outline-0 border-b-1 border-x-0 border-t-0 rounded-none px-0'>
                  <SelectValue placeholder='情報収集' />
                </SelectTrigger>
                <SelectContent className=' bg-white text-[#AAA]'>
                  <SelectGroup>
      ...
      {/* ============Aboutsiu=================== */}
      <div className='container flex justify-center py-[4rem] md:py-[8rem] flex-col '>
      ...
      <footer className='bg-[#1B273D]'>
        <div className='flex flex-col px-4 md:flex-row md:px-0 container py-8  gap-4'>
          ...
          <div className='flex justify-center flex-col gap-7 w-full md:w-[70%]'>
            <div className='flex flex-col md:flex-row w-full gap-10'>
              <Select>
                <SelectTrigger className='max-w-xl w-full outline-0 text-[#FFF] border-b-1 border-x-0 border-t-0 rounded-none px-0'>
                  <SelectValue placeholder='情報収集' />
                </SelectTrigger>
                <SelectContent className=' bg-white text-[#AAA]'>
                  <SelectGroup>
              ...
              <Select>
                <SelectTrigger className='max-w-xl text-[#FFF] outline-0 border-b-1 border-x-0 border-t-0 rounded-none px-0'>
                  <SelectValue placeholder='情報収集' />
                </SelectTrigger>
                <SelectContent className=' bg-white text-[#AAA]'>
                  <SelectGroup>
              ...
              <Select>
                <SelectTrigger className='max-w-xl outline-0 text-[#FFF] border-b-1 border-x-0 border-t-0 rounded-none px-0'>
                  <SelectValue placeholder='情報収集' />
                </SelectTrigger>
                <SelectContent className=' bg-white text-[#AAA]'>
                  <SelectGroup>
        ...
        <p className='block md:hidden bg-black py-2 text-white text-[13px] text-center'>
          Copyright 2023@ all right
        </p>
      </footer>
    </main>
