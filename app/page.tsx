...
export default function Home() {
  ...
  return (
    <main className=' min-h-screen '>
      ...
      <div className='container flex justify-center py-[8rem] flex-col'>
        ...
        <div className='mt-5'>
          ...
          <div className='flex justify-center items-end'>
            ...
            <div className='w-[37%] mb-9 ml-4 '>
              <p className='text-[#06053A] font-bold text-[27px] leading-[40px] mb-4 '>
                Guide Botで電子文書検索が簡単に！
              </p>
              <p className='text-[#06053A] text-[16px] leading-[30px]'>
                当社はAzure
      ...
      {/* =============Userbenefitsiu================== */}
      <div className='container flex justify-center pt-[12rem] pb-[6rem] flex-col'>
        <div className='text-center flex justify-center flex-col items-center'>
          <h4 className='text-[20px] font-bold text-[#00ADB5] bg-red pb-1  max-w-fit mx-auto tracking-5 uppercase'>
            USER BENEFIT
          </h4>
        ...
        <div className='mt-5 flex flex-col gap-9'>
          ...
          <div className=' w-[60%] mx-auto text-center gap-9 flex flex-col'>
            <p className='h-[50px] text-[14px] font-bold bg-[#F0F2F3] px-[5rem] flex items-center  justify-center rounded-2xl'>
